        ...
        <div class="row">
            ...
            <?php else : ?>
                <article class="col">
                    ...
                    <img class="col l6 m4 s12" src="<?= ROOT_URL ?>static/img/posts/product-images/<?= $this->oPost->image ?>" alt="<?= $this->oPost->title ?>">
                    <div class="col l6 m8 s12">
                        <p><?= nl2br($this->oPost->body) ?></p>
                        <p><strong>Hauteur, CM: <strong><?= nl2br($this->oPost->hauteurCM) ?></p>
                        <p><strong>Feuillage: <strong><?= nl2br($this->oPost->feuillage) ?></p>
                        <p><strong>Floraison: <strong><?= nl2br($this->oPost->floraison) ?></p>
                        <p><strong>Mode de Vie: <strong><?= nl2br($this->oPost->modeVie) ?></p>
                        <p><strong>Nom Commun: <strong><?= nl2br($this->oPost->nomCommun) ?></p>
                    </div>
