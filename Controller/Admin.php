    ...
    public function editPost()
    {
      ...
      if (isset($_POST['edit_submit']))
      {
        ...
        else
        {
          ...
          $aData = array('post_id' => $_GET['id'], 'title' => $_POST['title'], 'body' => $_POST['body'], 'hauteurCM' => $_POST['hauteurCM'], 'feuillage' => $_POST['feuillage'], 'floraison' => $_POST['floraison'], 'modeVie' => $_POST['modeVie'], 'nomCommun' => $_POST['nomCommun']);
