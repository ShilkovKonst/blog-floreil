...
?>
<script>window.location.replace('blog_post_<?= $_GET['id'] ?>.html');</script>
<?php $this->oUtil->sSuccMsg = 'Le Commentaire a été posté !';
			}
		}
...
<?php $this->oUtil->sSuccMsg = 'Votre compte a été créé, vous pouvez maintenant vous connecter';
			}
		}
