...
class Admin extends Blog
{
  ...
  {
    $oStmt = $this->oDb->prepare('UPDATE Posts SET title = :title, body = :body, nomCommun = :nomCommun, hauteurCM = :hauteurCM, feuillage = :feuillage, floraison = :floraison, modeVie = :modeVie WHERE id = :postId LIMIT 1');
